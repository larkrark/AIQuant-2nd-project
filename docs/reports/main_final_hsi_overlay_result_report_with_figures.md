...
![Fig 2. 누적수익률 비교](../../output/figures/main_final_report_cumulative_comparison.png)
...
![Fig 3. Drawdown 비교](../../output/figures/main_final_report_drawdown_comparison.png)
...
### 그림 5. λ별 성과와 평균 Turnover 비교

아래 그림은 λ 값별 CAGR과 평균 Turnover를 비교한다.

![Fig 5. λ별 성과와 평균 Turnover 비교](../../output/figures/main_final_report_lambda_family_comparison.png)
...
### 그림 6. 최종 후보 Turnover 비교

아래 그림은 최종 후보들의 평균 Turnover와 최대 Turnover를 비교한다.

![Fig 6. 최종 후보 Turnover 비교](../../output/figures/main_final_report_turnover_comparison.png)
...
![Fig 7. 거래비용 민감도 비교](../../output/figures/main_final_report_cost_drag_comparison.png)
...
![Fig 8. 위험-수익 산점도](../../output/figures/main_final_report_risk_return_scatter.png)
...
| 그림 | 파일 | 상태 |
|---|---|---|
| HSI 5상태 분포 | `output/figures/main_final_report_hsi_state_distribution_bar.png` | 생성 확인 |
| 누적수익률 비교 | `output/figures/main_final_report_cumulative_comparison.png` | 생성 확인 |
| Drawdown 비교 | `output/figures/main_final_report_drawdown_comparison.png` | 생성 확인 |
| λ별 성과와 Turnover 비교 | `output/figures/main_final_report_lambda_family_comparison.png` | 생성 확인 |
| 후보 판단 분포 도넛차트 | `output/figures/main_final_report_candidate_decision_donut.png` | 생성 확인 |
| 후보 판단 분포 막대바 | `output/figures/main_final_report_candidate_decision_bar.png` | 생성 확인 |
| 최종 후보 Turnover 비교 | `output/figures/main_final_report_turnover_comparison.png` | 생성 확인 |
| 거래비용 민감도 비교 | `output/figures/main_final_report_cost_drag_comparison.png` | 생성 확인 |
| 위험-수익 산점도 | `output/figures/main_final_report_risk_return_scatter.png` | 생성 확인 |
